...
def get_data(french_training_file, english_training_file, french_test_file, english_test_file):
    ...
    french_train, english_train = pad_corpus(french_train, english_train)
    ...
    french_vocab, french_padID = build_vocab(french_train)

    #5) Build vocab for english (see build_vocab)
    english_vocab, english_padID = build_vocab(english_train)

    #6) Convert training and testing english sentences to list of IDS (see convert_to_id)
    english_train = convert_to_id(english_vocab, english_train)
    ...
    french_train = convert_to_id(french_vocab, french_train)
    french_test = convert_to_id(french_vocab, french_test)

    return (english_train, english_test, french_train, french_test, english_vocab, french_vocab, english_padID)